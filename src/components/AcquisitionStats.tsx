...
const AcquisitionStats = () => {
  ...
  return (
    <div className="py-10 bg-netflix-darkGray bg-opacity-50">
      <div className="container mx-auto px-4">
        {recentBuyer && (
          <div className="mb-6 p-3 bg-gradient-to-r from-netflix-darkGray to-netflix-gray border border-netflix-red rounded-md flex items-center animate-slide-in shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="bg-netflix-gray border-netflix-darkGray hover:shadow-[0_0_15px_rgba(229,9,20,0.3)] transition-all duration-300">
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center">
                <BarChart className="text-netflix-red h-8 w-8 mr-3" />
                <div>
                  <p className="text-netflix-lightGray text-sm">Taxa de conversão</p>
                  <div className="flex items-baseline">
                    <p className="text-2xl font-bold">{purchasePercentage}%</p>
                    <p className="text-netflix-lightGray text-sm ml-2">compram em {displayTimeValue}</p>
                  </div>
                </div>
              </div>
              <Progress className="mt-3 h-2" value={purchasePercentage} />
            </CardContent>
          </Card>
        </div>
      </div>
